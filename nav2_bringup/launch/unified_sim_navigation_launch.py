#### [시뮬레이션 전용] localization(AMCL 포함) + navigation 통합 네비게이션 런치 파일 ####
#### 원본 unified_navigation_launch.py 기반.
#### 차이점:
####   1. AMCL 노드 활성화 (non-composition + composition 양쪽)
####   2. localization_lifecycle_nodes에 'amcl' 추가
####   3. use_sim_time 기본값 'true' (Gazebo /clock 사용)
